...
//            mapper.getEmpsByConditionsIf(employee);
//            mapper.getEmpsByConditionsTrim(employee);
            mapper.getEmpsByConditionsChoose(employee);
        }finally {
            sqlSession.close();
        }
    }
    ...
    public void test9() throws IOException {
        ...
        try{
            EmployeeMapperDynamicSQL mapper = sqlSession.getMapper(EmployeeMapperDynamicSQL.class);
            Employee employee = new Employee(3, "admin", null, null, null);
    ...
    public void test10() throws IOException {
        ...
        try{
            EmployeeMapperDynamicSQL mapper = sqlSession.getMapper(EmployeeMapperDynamicSQL.class);
            List<Employee> list = mapper.getEmpsByConditionsForeach(Arrays.asList(3, 4, 5));
